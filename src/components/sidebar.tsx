...
const SiderBar = () => {
  ...
  //   return () => {
  //     toggleSidebarMobileSearch?.removeEventListener("click", () => {
  //       console.log('444444')
  //       toggleSidebarMobile()
  //     });
  //     toggleSidebarMobileEl?.removeEventListener("click", () => {
  //       console.log('444444')
  //       toggleSidebarMobile()
  //     });

  //     sidebarBackdrop?.removeEventListener("click", () => {
  //       console.log('444444')
  //       toggleSidebarMobile()
  //     });
  //   };
  ...
  useEffect(() => {
    ...
    // Toggle için bir fonksiyon tanımlayın ve bu fonksiyonu hem eklemek hem de kaldırmak için kullanın.
    const handleToggleClick = () => {
      toggleSidebarMobile();
    };

    // Event listener'ları ekleyin
    toggleSidebarMobileSearch?.addEventListener("click", handleToggleClick);
    toggleSidebarMobileEl?.addEventListener("click", handleToggleClick);
    sidebarBackdrop?.addEventListener("click", handleToggleClick);

    // Cleanup fonksiyonu
    return () => {
      // Aynı fonksiyon referansını kullanarak event listener'ları kaldırın
      toggleSidebarMobileSearch?.removeEventListener(
        "click",
        handleToggleClick,
      );
      toggleSidebarMobileEl?.removeEventListener("click", handleToggleClick);
      sidebarBackdrop?.removeEventListener("click", handleToggleClick);
    };
  }, []);
  return (
    <div>
